...
/* NSDRMEM */
   VALUE $MAJOR_GROUP_USDOC_CODES_NEW
...
/* NSDRMEN */
   VALUE $MINOR_GROUP_USDOC_CODES_NEW
...
/* BAPBPR D2PBPR D3PBPR HDPBPR MRPBPR PUBPRI SDRPBPR */
...
/* ACADV ACCAR ACCCEP ACCHG ACINT ACLIC ACSIN ACSKL ACTCAP ACTDED
   ...
   CHU2IN CHUN12 CTZUSIN EMED FNINUS FTPRET GOVSUP HCAPIN JOBINS JOBPENS
   JOBPROFT JOBVAC LOOKWK MARIND MGRNAT MGROTH MGRSOC MINRTY MRADV MRCAR
   MRCHG MRINT MRLIC MRSKL NEWBUS NRCHG NRCON NRFAM NRLOC NROCNA
   NROT NRPAY NWFAM NWLAY NWNOND NWOCNA NWSTU PDEMPL PDEXPECT PDIX
   PDOTHER PDPERPL PDTRAIN PDTROUT PJFAM PJHAJ PJNOND PJOCNA PJOT PJRET
   PJSTU PJWTFT PROMTGI SPNAT SPOT SPSOC SUPWK TCDGCMP WAACC WAAPRSH
   WABRSH WACOM WADEV WADSN WAEMRL WAMGMT WAOT WAPROD WAQM WASALE
   WASVC WATEA WKTRNI WRKG WRKGP WTRCHOC WTREM WTRLIC WTROPPS WTROT
   WTRPERS WTRSKL */
   VALUE $YES_NO_CODES
      "L"	= "L: Logical Skip"
      "N"	= "N: No"
