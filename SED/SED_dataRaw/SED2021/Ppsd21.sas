...
/* ACADV ACCAR ACCCEP ACCHG ACINT ACLIC ACSIN ACSKL ACTCAP ACTDED
   ACTMGT ACTRD ACTRD2 ACTRDT ACTRES ACTTCH CH1218IN CH19IN CH25IN CH611IN
   CH6IN CHCHG CHCON CHFAM CHFAMCOV CHLAY CHLAYCOV CHLOC CHLVIN CHOT
   CHPAY CHRET CHSCH CHU2IN CHUN12 EMED FTPRET GOVSUP HCAPIN JOBINS
   JOBPENS JOBPROFT JOBVAC JOBVACCOV LOOKWK MGRNAT MGROTH MGRSOC MRADV MRCAR
   MRCHG MRINT MRLIC MRSKL NEWBUS NRCHG NRCON NRFAM NRLOC NROCNA
   NROT NRPAY NWFAM NWFAMCOV NWLAY NWLAYCOV NWNOND NWOCNA NWSTU PDEMPL
   PDEXPECT PDIX PDOTHER PDPERPL PDTRAIN PDTROUT PJFAM PJFAMCOV PJHAJ PJHRS
   PJHRSCOV PJNOND PJOCNA PJOCNACOV PJOT PJRET PJSTU PJWTFT PROMTGI SALCOV1
   SPNAT SPOT SPSOC SUPWK TCDGCMP WAACC WAAPRSH WABRSH WACOM WADEV
   WADSN WAEMRL WAMGMT WAOT WAPROD WAQM WASALE WASVC WATEA WKTRNI
   WRKG WRKGP WTRCHOC WTREM WTRLIC WTROPPS WTROT WTRPERS WTRSKL */
   VALUE $YES_NO_CODES
      "L"	= "L: Logical Skip"
      "N"	= "N: No"
      "Y"	= "Y: Yes"
