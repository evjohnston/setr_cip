...
metadata_folder = "IPEDS/IPEDS_definitions"
rawdata_folder = "IPEDS/IPEDS_dataRaw/IPEDS_dataRaw_CSVs_V2"
...
main_df.to_csv(f"IPEDS/IPEDS_dataCleaned/{YEAR}_cleaned.csv", index=False)
